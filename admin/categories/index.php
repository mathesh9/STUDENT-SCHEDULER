						...
						<tr>
							...
							<td align="center">
								...
								<div class="dropdown-menu" role="menu">
									<a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View Tasks</a>
...
<script>
	$(document).ready(function() {
		...
		$('.view_tasks').click(function() {
			location.href = "categories/view_category.php?id=" + $(this).attr('data-id');
		})
